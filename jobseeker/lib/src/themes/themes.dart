...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(4278740863),
      onPrimary: Color(4294967295),
      primaryContainer: Color(4281302422),
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4282508995),
    value: Color(4282508995),
    light: ColorFamily(
      color: Color(4279003993),
      onColor: Color(4294967295),
      colorContainer: Color(4288803547),
      onColorContainer: Color(4278198297),
    ),
    ...
    dark: ColorFamily(
      color: Color(4287026879),
      onColor: Color(4278204461),
      colorContainer: Color(4278210882),
      onColorContainer: Color(4288803547),
    ),
