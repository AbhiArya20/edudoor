...
import 'package:jobseeker/src/blocs_cubits/application_bloc/application_bloc.dart';
import 'package:jobseeker/src/blocs_cubits/authentication_bloc/authentication_bloc.dart';
// import 'package:jobseeker/src/blocs_cubits/Internet_check_cubit/internet_cubit.dart';
// import 'package:jobseeker/src/blocs_cubits/aadhar_verification_bloc/aadhar_verification_bloc.dart';
// import 'package:jobseeker/src/blocs_cubits/bottom_navigator_startup_bloc/bottom_navigator_startup_bloc.dart';
...
// import 'package:jobseeker/src/blocs_cubits/redirect_bloc/redirect_bloc.dart';
...
class AllBloc {
  ...
  // static final JobTitleBloc jobTitleBloc = JobTitleBloc();
  // static final AadharVerificationBloc aadharVerificationBloc = AadharVerificationBloc();
  ...
  static final List<BlocProvider> providers = [
    ...
    // ),
    // BlocProvider<JobTitleBloc>(
    //   create: (context) => jobTitleBloc,
    // ),
    // BlocProvider<AadharVerificationBloc>(
    //   create: (context) => aadharVerificationBloc,
    // ),
