...
import 'package:jobseeker/src/view/authentication/otp_screen/widgets/otp_info_widget.dart';
import 'package:jobseeker/src/view/authentication/otp_screen/widgets/otp_input_field.dart';
import 'package:jobseeker/src/view/authentication/otp_screen/widgets/resend_otp_widget.dart';
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 10.sp,
                fontWeight: FontWeight.bold,
                color: Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(.5) ?? Theme.of(context).primaryColor,
              ),
